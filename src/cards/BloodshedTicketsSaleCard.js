...
export default function BloodshedTicketsSaleCard({buyTickets, disabledVar, vegldBalance}){
        ...
        <div className="farm-card">
            <Row>
                <Col xs={12}>
                    ...
                    <Card.Img variant="top" src={logoTitle} style={{height: '70px', width: '140px', marginTop: '-80px'}}/>
                </Col>
                <Col xs={12}>
                ...
                <Col xs={{offset: 1, span: 10}}>
                    ...
                    <Col xs={12}>
                        <Button variant="success" className="btn btn-sm btn-block" disabled={disabledVar} onClick={() => increaseAmount(1)}>
                            <FontAwesomeIcon fontSize={"medium"} icon={faAdd} color="white" />
                            <span className="ms-2">Buy more</span>
                        </Button>
                    </Col>
                    <Col xs={12}>
                        <Button variant="danger" className="btn btn-sm btn-block mt-1" disabled={disabledVar} onClick={() => decreaseAmount(1)}>
                            <FontAwesomeIcon fontSize={"medium"} icon={faMinus} color="white" style={{marginLeft: '-9px'}} />
